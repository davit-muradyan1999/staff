<template>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="row bg-white align-items-center">
        ...
        <div class="col-md-4">
          <Link class="edit-action-link" :href="route('admin.currencies.create')">
  ...
  <div class="mt-3">
    <div class="card mt-3" v-for="currency in currencies" :key="currency.id">
      <div class="card-body p-3 position-relative">
        <div class="row bg-white align-items-center">
          <div class="col-md-1 col-sm-12 border-end">{{ currency.id }}</div>
          <div class="col-md-9 col-sm-12 border-end">{{ currency.name }}</div>
          ...
          <font-awesome-icon
            ...
            @click="
              ...
              (deleteModal.data = currency),
              (deleteModal.url.value = 'admin.currencies.destroy')
            "
          />
          </div>
        </div>
