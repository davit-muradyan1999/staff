<template>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="row bg-white align-items-center">
        ...
        <div class="col-md-4">
          <Link class="edit-action-link" :href="route('admin.partners.create')">
  ...
  <div class="mt-3">
    <div class="card mt-3" v-for="partner in partners" :key="partner.id">
      <div class="card-body p-3 position-relative">
        <div class="row bg-white align-items-center">
          <div class="col-md-1 col-sm-12 border-end">{{ partner.id }}</div>
          <div class="col-md-9 col-sm-12 border-end">{{ partner.name.ru }}</div>
          ...
          <font-awesome-icon
            ...
            @click="
              ...
              (deleteModal.data = partner),
              (deleteModal.url.value = 'admin.partners.destroy')
            "
          />
          </div>
        </div>
