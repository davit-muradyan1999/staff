<template>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="row bg-white align-items-center">
        ...
        <div class="col-6">
          <Link class="edit-action-link" :href="route('admin.positions.create')">
  ...
  <div class="mt-3">
    <div class="card mt-3" v-for="position in positions" :key="position.id">
      <div class="card-body p-3 position-relative">
        <div class="row bg-white align-items-center">
          <div class="col-md-1 col-sm-12 border-end">{{ position.id }}</div>
          <div class="col-md-9 col-sm-12 border-end">{{ position.name.ru }}</div>
          <div class="col-md-2 col-sm-12 actions">
            ...
            <font-awesome-icon
              ...
              @click="
                ...
                (deleteModal.data = position),
                (deleteModal.url.value = 'admin.positions.destroy')
              "
            />
          </div>
        </div>
