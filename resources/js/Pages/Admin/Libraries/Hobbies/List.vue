<template>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="row bg-white align-items-center">
        ...
        <div class="col-6">
          <Link class="edit-action-link" :href="route('admin.hobbies.create')">
  ...
  <div class="mt-3">
    <div class="card mt-3" v-for="hobby in hobbies" :key="hobby.id">
      <div class="card-body p-3 position-relative">
        <div class="row bg-white align-items-center">
          <div class="col-md-1 col-sm-12 border-end">{{ hobby.id }}</div>
          <div class="col-md-9 col-sm-12 border-end">{{ hobby.name.ru }}</div>
          ...
          <font-awesome-icon
            ...
            @click="
              ...
              (deleteModal.data = hobby),
              (deleteModal.url.value = 'admin.hobbies.destroy')
            "
          />
          </div>
        </div>
