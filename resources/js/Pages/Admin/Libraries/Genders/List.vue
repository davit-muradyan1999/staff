<template>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="row bg-white align-items-center">
        ...
        <div class="col-6">
          <Link class="edit-action-link" :href="route('admin.genders.create')">
  ...
  <div class="mt-3">
    <div class="card mt-3" v-for="gender in genders" :key="gender.id">
      <div class="card-body p-3 position-relative">
        <div class="row bg-white align-items-center">
          <div class="col-md-1 col-sm-12 border-end">{{ gender.id }}</div>
          <div class="col-md-9 col-sm-12 border-end">{{ gender.name.ru }}</div>
          <div class="col-md-2 col-sm-12 actions">
            <Link
            class="edit-action-link"
            :href="route('admin.genders.edit', gender.id)"
          >
          ...
          <font-awesome-icon
            ...
            @click="
              ...
              (deleteModal.data = gender),
              (deleteModal.url.value = 'admin.genders.destroy')
            "
          />
          </div>
        </div>
